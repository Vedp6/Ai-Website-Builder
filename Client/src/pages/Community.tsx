            ...
            <div className="py-10 min-h-[80vh]">
              ...
              <div className="flex flex-wrap gap-3.5">
                {projects.map((project) => (
                  ...
                  target="_blank"
                   key={project.id} className=" w-72 max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg overflow-hidden group  hover:border-indigo-800/80 duration-300 transition-all">
                          ...
                          <div  className="flex justify-between items-center mt-6">
                            ...
                            <div className="flex gap-2 text-white tex-sm">
                              <button className="px-3 py-1.5 bg-white/10 hover:bg-white/15 rounded-md transition-colors flex items-center gap-2">
                                <span className="bg-gray-200 border size-4.5 rounded-full font-semibold flex items-center justify-center text-black">
